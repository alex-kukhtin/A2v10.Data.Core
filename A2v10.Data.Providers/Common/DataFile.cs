...
public class DataFile : IExternalDataFile
{
	...
	private readonly Byte[] byteCodes1251 = [0x81, 0x83, 0x92, 0x93, 0x94, 0x97, 0xA0, 0xA1, 0xA2, 0xA5, 0xA8, 0xAA, 0xAF, 0xB2, 0xB3, 0xB4, 0xB9, 0xBA, 0xBF, 0xBB, 0xAB, 0xB0];
	...
	public Field CreateField(String name, SqlDataType dataType, Int32? len = null, Int32? dec = null)
	{
		var f = new Field(name);
		switch (Format)
		{
			case DataFileFormat.dbf:
				f.SetFieldTypeDbf(dataType, len, dec);
				break;
