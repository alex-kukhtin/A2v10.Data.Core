...
internal static class InternalHelpers
{
    ...
    {
        if (_typeName2DataType.TryGetValue(s, out DataType dt))
            return dt;
    ...
    {
        if (_typeName2FieldTypeMap.TryGetValue(s, out FieldType ft))
            return ft;
    ...
    public static List<ExpandoObject> GetArray(this ExpandoObject eo, String key)
    {
        ...
        else
        {
            if (objArr is not List<ExpandoObject> eobjArr)
                throw new DataLoaderException("AddToArrayColumns. Invalid element type");
            arr = eobjArr;
        }
        return arr;
    }
    ...
    private static readonly IReadOnlyDictionary<String, SqlDataType> _name2SqlTypeMap = new Dictionary<String, SqlDataType>(StringComparer.OrdinalIgnoreCase)
    {
    ...
    public static readonly IReadOnlyDictionary<String, FieldType> _typeName2FieldTypeMap = new Dictionary<String, FieldType>()
    {
        ["Object"] = FieldType.Object,
        ["LazyObject"] = FieldType.Object,
        ["MainObject"] = FieldType.Object,
        ["MapObject"] = FieldType.MapObject,
        ["Array"] = FieldType.Array,
        ["LazyArray"] = FieldType.Array,
    ...
    private static IReadOnlyDictionary<String, DataType> _typeName2DataType = new Dictionary<String, DataType>()
    {
